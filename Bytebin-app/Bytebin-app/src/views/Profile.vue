    ...
    <el-main style="width: 80%;margin: 0 auto">
      <el-card style="height: 150px">
        <el-row style="height: 120px">
          ...
          <!-- <el-col :span="3" style="text-align: center;line-height: 120px">
            <span style="font-size: 20px;font-weight: bolder">
              个人总积分:{{getpoint(user)}}</span>
          </el-col> -->
          <el-col :span="8" style="text-align: right;line-height: 100px">
