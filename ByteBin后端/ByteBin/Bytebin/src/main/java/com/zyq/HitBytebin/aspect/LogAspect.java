...
import com.zyq.HitBytebin.serivce.LogService;
...
public class LogAspect {
    ...
    @Pointcut("execution(* com.zyq.HitBytebin.controller.*.*(..))")
    public void allController() {
    }

    @Pointcut("execution(* com.zyq.HitBytebin.controller.AdviceController.*(..))")
